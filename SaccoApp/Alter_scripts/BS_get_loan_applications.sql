...
if (@LoanNo is null or @LoanNo='' or @LoanNo='null')
	begin
		...
		upper(WitSigned)WitSigned, WitMemberNo, (wtm.OtherNames+' '+ wtm.SurName)WitnessNames,
		upper(SupSigned)SupSigned, SupMemberNo, (spm.OtherNames+' '+ spm.SurName)SupervisorNames,
		...
		left join BS_MEMBERS as wtm on (wtm.MemberNo collate Latin1_General_CI_AS =l.MemberNo collate Latin1_General_CI_AS)
		left join BS_MEMBERS as spm on (spm.MemberNo collate Latin1_General_CI_AS =l.SupMemberNo collate Latin1_General_CI_AS)
