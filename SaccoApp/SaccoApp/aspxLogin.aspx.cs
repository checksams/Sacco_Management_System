    ...
    public partial class aspxLogin : System.Web.UI.Page
    {
        ...
        private bool ValidateUser( string userName, string passWord )
        {
	        ...
	        try
	        {
                ...
                //mysqlCmm = new SqlCommand("Select usr_pwd from BS_users where usr_name=@userName and usr_pwd=SUBSTRING(sys.fn_sqlvarbasetostr(HASHBYTES('MD5', @pwd)),3,32)", mysqlConn);
                mysqlCmm = new SqlCommand("Select usr_pwd from BS_users where usr_name=@userName and usr_pwd=dbo.MD5(@pwd)", mysqlConn);
