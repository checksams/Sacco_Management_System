    ...
    public partial class aspxUsers : System.Web.UI.Page
    {
        ...
        private Boolean User_Update()
        {
            ...
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine("v_pwd_reset =====>"+ ddlPwdReset.SelectedValue.ToString());
                cmd.Parameters.Add(new SqlParameter("@v_usrcode", SqlDbType.Int));
                cmd.Parameters["@v_usrcode"].Direction = ParameterDirection.Output;
                cmd.Connection.Open();

                System.Diagnostics.Debug.WriteLine("v_pwd_reset 222 =====>" + ddlPwdReset.SelectedValue.ToString());
                cmd.ExecuteNonQuery();

                System.Diagnostics.Debug.WriteLine("v_pwd_reset 333 =====>" + ddlPwdReset.SelectedValue.ToString());
